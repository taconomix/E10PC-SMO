...
/*== Discounts on Configured Pricing =======================================*/
	...
	//-- Overwrite Discounts on Special Intra-Company Prices ----------------
		...
		bool kInternal = custGrp=="TRIC" || custGrp=="HGIC" || custGrp=="INC";
		if ( kInternal && sDevKey!="UCB" && sDevKey!="TRA" ) {
...
/*== CHANGE LOG ==============================================================
	...
	01/31/2023: Adjust Internal Pricing/Disc for new CustGroups TRIC,HGIC;
