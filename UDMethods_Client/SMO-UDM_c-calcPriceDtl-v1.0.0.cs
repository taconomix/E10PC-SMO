/*== calcPriceDetail v1.0.0 ==================================================

	Created: 01/13/2023 -Kevin Veldman
	Changed: 
	
	File: SMO-UDM_c-calcPriceDtl-v1.0.0.cs
...
/*== Discounts on Configured Pricing =======================================*/
	...
	//-- Set Condition/Multiplier for each discountID -----------------------
		...
		decimal coupaBoot  = kBoot? 1: 0;
		decimal coupaDAJ   = 0;
		decimal coupaTAM   = 0;
		decimal coupaChip  = Inputs.kDorsalChip.Value && lkpSpecs("ChipsIncluded")!="X"? 1: 0;
		decimal top22      = 1;
		decimal ottoWRI    = 1;
		decimal ottoSAR    = 1;
		decimal ottoABIL   = 1;
		...
		decimal coupaRushS = prcRush > 0 && !Inputs.k0day.Value? 1/dQty: 0;
		decimal coupa0DayS = prcRush > 0 &&  Inputs.k0day.Value? 1/dQty: 0;
		decimal coupaRushA = 0;
		decimal coupa0DayA = 0;
		decimal coupaSOL   = 0;
		decimal coupaBSA   = 0;
		decimal coupaSMO   = sKey=="SMO"? 1: 0;
		decimal coupaBIG   = lkpSpecs("SPEC")=="BIGSHOT"? 1: 0;
		decimal coupaTLS   = 0;
		decimal coupaPUL   = 0;
		decimal coupaUCB   = sKey=="UCB"? 1: 0;
